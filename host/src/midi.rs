...
impl MidiState {
    pub fn new() -> Self {
        Self {
            ...
            gate: AtomicU8::new(0),
            vel: AtomicU8::new(127),
        }
    }
}

pub struct MidiController {
    pub state: Arc<MidiState>,
}

impl MidiController {
    pub fn start_midi(&self) -> Result<midir::MidiInputConnection<Arc<MidiState>>, String> {
...
fn handle_midi(midi_state: &MidiState, msg: &[u8]) {
